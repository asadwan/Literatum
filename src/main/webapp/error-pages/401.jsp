...
<c:set var="path" value="${requestScope.get('javax.servlet.forward.request_uri')}"/>
...
<div class="cover">
    ...
    <p class="lead">The requested resource requires authentication.</p>
    <p><a href="/${pathParts[0]}/login">Login</a></p>
</div>
